"""
Page: Questao Selector Dialog
Diálogo para selecionar questões para adicionar a uma lista
"""
...
class QuestaoSelectorCard(QFrame):
    ...
    checkChanged = pyqtSignal(object, bool)
...
class QuestaoSelectorDialog(QDialog):
    ...
    def __init__(self, questoes_ja_na_lista: List = None, parent=None):
        ...
        self.questoes_selecionadas: Dict = {}
